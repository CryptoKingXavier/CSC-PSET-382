...
class BinarySearchTree {
    ...
    // The insert method takes a value as parameter and inserts the value inits corresponding place within the tree
    insert(value) {
    ...
    // The contains method takes a value as parameter and returns true if the value is found within the true
    contains(value) {
        if (this.root = null) return false
        let current = this.root, found = false
        while (current && !found) {
