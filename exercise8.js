...
class SinglyLinkedList {
  ...
  // The get method takes an index number as parameter and returns th value of the node at that index
  get(index) {
  ...
  // The set method takes and index number and a value as parameters, and modifies the node value at the given index in the list
  set(index, val) {
